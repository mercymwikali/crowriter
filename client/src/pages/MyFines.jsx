...
import { deleteFine, finesList, freelancerFines, updateFine } from '../actions/fineActions';
...
const MyFines = () => {
  ...
  const { loading, error, success, fines } = useSelector((state) => state.freelancerFines);
...
const userId=useAuth().user.id
  ...
  useEffect(() => {
    dispatch(freelancerFines(userId));
